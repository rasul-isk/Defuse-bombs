...
const DifficultyCard = ({ difficulty, description, onClick }) => {
  return (
    <Box className="container-item" onClick={() => onClick({ switch: 'difficulty', value: difficulty })} bgcolor={colors.primary[500]} sx={{ display: 'block', padding: '30px 0', cursor: 'pointer' }}>
